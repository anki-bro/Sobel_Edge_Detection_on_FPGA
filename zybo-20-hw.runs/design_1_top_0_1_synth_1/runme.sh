...
HD_PWD='C:/ANKUSH_Psuedo-Disk/AUV/hdmi/zybo-20-hw.runs/design_1_top_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_0_1.tcl
